    ...
    methods: {
        changeWing(item, main, premade, ab) {
            ...
            if (item) {
                ...
                if (premade) {
                    const selected = this.premadeimages[2]
                    model = item.model
